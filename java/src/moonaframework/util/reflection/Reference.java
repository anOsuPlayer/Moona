...
public abstract sealed class Reference<T extends AnnotatedElement> extends Reflection<T> permits Type, Constructor, Method, Field, Parameter, Generic, RawType, RecordComponent {
	...
	protected Reference() {
		...
		if (strictContext.evaluate() || (Moona.autoReflections.evaluate() && !Moona.isOn())) {
			derive();
		}
	}
}
