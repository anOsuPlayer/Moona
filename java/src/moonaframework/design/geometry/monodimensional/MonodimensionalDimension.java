...
public interface MonodimensionalDimension<T extends Number> extends MonodimensionalSize<T>, Resizable1DType<T> {
	...
	public static class IntegralDimension1D extends IntegralSize1D implements MonodimensionalDimension<Integer>, IntegralResizable1D {
		...
		public IntegralDimension1D(IntegralDimensional3D dim, Size width) throws NullPointerException {
			super(dim, width);
		}
		public IntegralDimension1D(IntegralDimensional2D dim, Size width) throws NullPointerException, IllegalArgumentException {
			super(dim, width);
		}
	...
	public static class Dimension1D extends Size1D implements MonodimensionalDimension<Float>, Resizable1D {
		...
		public Dimension1D(Dimensional3D dim, Size width) throws NullPointerException {
			super(dim, width);
		}
		public Dimension1D(Dimensional2D dim, Size width) throws NullPointerException, IllegalArgumentException {
			super(dim, width);
		}
	...
	public static class DoubleDimension1D extends DoubleSize1D implements MonodimensionalDimension<Double>, DoubleResizable1D {
		...
		public DoubleDimension1D(DoubleDimensional3D dim, Size width) throws NullPointerException {
			super(dim, width);
		}
		public DoubleDimension1D(DoubleDimensional2D dim, Size width) throws NullPointerException, IllegalArgumentException {
			super(dim, width);
		}
