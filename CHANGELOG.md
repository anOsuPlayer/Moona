...
* **Added Flares:** A Flare is nothing but a container of multiple similar Reflections. It allows a type argument such that a Flare\<T\> acts as a container for *any Reflection of type T* (with T having Reflection\<?\> as an upper bound). Flares are mostly used with the derivation process, which will be explained later. To put it briefly, a derived Flare is nothing but _a Flare containing Reflections related to a certain Reference_.
