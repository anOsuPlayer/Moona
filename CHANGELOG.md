...
> NOTE: Each Functional can either be translated in *a Supplier\<E\>, a Consumer\<E\> or a Function<R, T>*, except for the Snippet, which _translates into a Runnable_.
